...
% Last Modified by GUIDE v2.5 17-May-2022 20:15:22
...
global originalImage2;
s=size(originalImage);
 originalImage2=imresize( originalImage2,[s(1),s(2)]);
 axes(handles.axes3)
global a;
a= originalImage-  originalImage2;
imshow( a);
title("result photo");
