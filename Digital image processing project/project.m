...
% Last Modified by GUIDE v2.5 03-May-2022 19:20:56
...
[filename, pathname] = uigetfile({'*.jpg';'*.jpeg'});
 ...
 InfoImage = imfinfo(image);
  set(handles.edit2,'String',InfoImage.Format);
 set(handles.edit3,'String',num2str(InfoImage.Width));
 set(handles.edit5,'String',num2str(InfoImage.Height));
  set(handles.edit6,'String',num2str(InfoImage.FileSize));
   set(handles.edit7,'String',image);
